...
`@stage-cut/react-player` uses `@remotion/player` and `remotion` as its internal playback adapter. Those packages have licensing requirements independent from Stagecut's MIT License, and some companies may need a Remotion license.
